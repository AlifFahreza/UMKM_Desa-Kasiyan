		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 5px;">
					<span> <i class="glyphicon glyphicon-link"></i> www.kasiyanjember.com</span>
				</div>

				<div class="col-md-4"  style="padding: 5px;">
					<span><i class="glyphicon glyphicon-envelope"></i> desakasiyanpuger@gmail.com</span>
				</div>

				<div class="col-md-4"  style="padding: 5px;">
					<span><i class="glyphicon glyphicon-map-marker"></i> Jl. Mataram No.04 Dusun Krajan</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #C16A2C"><b>UMKM-DESA KASIYAN</b></a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="manual.php">Panduan Penggunaan</a></li>
					<?php 
					if(isset($_SESSION['kd_cs'])){
					$kode_cs = $_SESSION['kd_cs'];
